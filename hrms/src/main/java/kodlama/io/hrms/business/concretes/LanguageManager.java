...
public class LanguageManager implements LanguageService {
	...
	@Override
	public DataResult<List<Language>> add(List<Language> language) {
		return new SuccessDataResult<>(this.languageDao.saveAll(language) , "yabancı dil başarıyla eklendi");
	}
